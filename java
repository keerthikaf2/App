package com.task3.myquizapplication;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view){
        ...
        if(clickButton.getId()==R.id.submit_btn){
            ...
            loadNewQuestion();
            if(selectdAnswer.equals(QuestionAnswer.correctAnswers[currentQuestionIndex])){
                score++;
            }

        }else{
            //choices button clicked
            selectdAnswer =clickButton.getText().toString();
